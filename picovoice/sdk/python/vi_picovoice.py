...
# Tiếp tục với các bước khởi tạo và vòng lặp ghi âm của bạn
    ...
    def inference_callback(inference):
        ...
        if inference.is_understood:
            ...
            with open('/home/pi/picovoice/json/vi_changeLight.json', 'r') as json_file:
            ...
            for item in json_data:
                if item.get("intent") == inference.intent and item.get("slots") == inference.slots:    
                    ...
                    # Phát tệp âm thanh "thuchien.wav"
                    audio_file_path = "/home/pi/picovoice/audio/vi/thuchien.wav"
                    print("Dạ vâng, em sẽ thực hiện ngay ạ.")
                ...
                # Phát tệp âm thanh "thulai.wav"
                try_again_audio_file_path = "/home/pi/picovoice/audio/vi/thulai.wav"
                print("Có thể khẩu lệnh chưa chính xác, vui lòng thử lại ạ .")
